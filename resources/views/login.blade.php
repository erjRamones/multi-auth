                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{ route('account.authenticate') }}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class=" mt-10 d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{ route('admin.login') }}" class="link-secondary text-decoration-none">Admin Login</a>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
