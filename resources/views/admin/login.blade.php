                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{ route('admin.authenticate') }}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class=" mt-20 d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{ route('account.login') }}" class="link-secondary text-decoration-none">Employee Login</a>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
